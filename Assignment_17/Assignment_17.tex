\documentclass[journal,12pt,twocolumn]{IEEEtran}
 ...
 \graphicspath{ {/user/adarshsrivastava/desktop/Matrix Theory/Assignemnt_7} }
  ...
  \end{abstract}
   ...
   \begin{align}
   \myvec{a&b&c}\myvec{1&0&0\\t&1&0\\t^2&2t&1}\myvec{1\\x\\x^2}=0\\
   \myvec{1&x&x^2}\myvec{1&t&t^2\\0&1&2t\\0&0&1}\myvec{a\\b\\c}=0\\
   \vec{ABc}=0
   \end{align}
   ...
   \end{align}
   Since $\vec{B}$ is linearly independent so $\vec{c}$ will be zero vector. 
   We know that $\vec{c}$ is in the nullspace of $\vec{B}$ and hence it will also be in the nullspace of $\vec{AB}$.So,$\{g1,g2,g3\}$ are linearly independent.Now, to find the coordinates,
  \begin{multline}
