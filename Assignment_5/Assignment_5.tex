...
Find the area of the region bounded by the circle $\bf{x}^{T}$ $\bf{x}$= 4 and \norm{\vec{x}-\myvec{2\\0}}=2.
 ...
 \begin{align}
 {\vec{x}^T\vec{x}} + 2\vec{u_1}^T\vec{x} + f_1 = 0 = 0\\
...
Now,Subtracting equation \eqref{2.2.2} from \eqref{2.1.2} We get,
 ...
 \begin{align}
 \myvec{-1&0}\vec{x}=-1\\
\myvec{-1&0}\myvec{x_1\\x_2}=-1 \text{(Let x=\myvec{x_1\\x_2})}\\
 -x_1=-1\\
 x_1=1\\
 x=\myvec{1\\x_2}\label{2.2.12}
 \end{align}
 Substituting \eqref{2.2.12} in \eqref{2.1.2}
\begin{align}
 {\vec{x}^{T}\vec{x}}-4=0\\
 \norm{x}=4\\
 1+x_2^2=4\\
 x_2=+\sqrt{3},-\sqrt{3}\\
 x=\myvec{1\\\sqrt{3}},\myvec{1\\-\sqrt{3}}
\end{align}
