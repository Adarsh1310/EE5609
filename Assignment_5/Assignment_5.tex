...
Now,Subtracting equation \eqref{2.2.3} from \eqref{2.1.2} We get,
 ...
 \begin{align}
 \myvec{-1&0}\vec{x}=-1\\
 \vec{x} = \lambda \vec{m}+q, \text{where} \vec{m} = \myvec{0\\1}-1\\
 \vec{x} = \lambda \myvec{0\\1}-1\
 \end{align}
...
\lambda=\sqrt{3},-\sqrt{3}
 \end{align}
Substituting value of \lamda in \eqrt{},Points of intersection come out to be(-1,\sqrt{3}) and(-1,-\sqrt{3}),$Now finding the direction vector between point of intersection and origin of two circle.\\
