...
\vec{x}^{T}\vec{x}-2\vec(O)^{T}\vec{x}+\norm{\vec{O}}^2-\vec{r}^2=0\\
 ...
 \bf{x}^{T}\bf{x}= 2
 \end{align}
 radius=$\sqrt{2}$ and point of origin as (0,0)
 \subsection{Circle 2}
...
radius=2 and point of origin as (2,0)
 \begin{figure}[h!]
	...
	\label{myfig}
\end{figure}
Subtracting equation 2.0.4 from 2.0.1 We get,
 \begin{align}
 {\vec{x}^{T}\vec{x}-\myvec{4\\0}^T\vec{x}}-2-\bf{x}^{T}\bf{x}-2=0\\
 \myvec{4&0}\vec{x}=0
 \end{align}
 ...
 \end{align}
 Substituting 2.2.9 in 2.1.1\\
 \begin{align}
 \lambda\myvec{0\\1}\lambda\myvec{0&1}=2\\
 \lambda=\sqrt{2}
 \end{align}
 Substituting the value of $\lambda$ in x
 \begin{align}
 \vec{\lambda} = +\sqrt{2}\myvec{0\\1} and - \sqrt{2}\myvec{0\\1}
 \end{align}
 Now to find the area inclosed between these circles we have to find the integral of these point w.r.t the circles.For this we need to find the area of segment  and double it to find the area of the entire overlapped region. To find the area of segment we need angle segment makes.Here,\\
