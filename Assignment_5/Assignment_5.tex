...
Equation in general form is as follows:\\
 ...
 Now to find the area inclosed between these circles we have to find the integral of these point w.r.t the circles.\\
 \begin{align*}
 Area=2\int_{1}^{2}{\sqrt{4-x^{2}}}
 \\
 =2[\frac{x}{2}\sqrt{4-x^{2}}+2\sininv{\frac{x}{2}}]_{1}^{2}\\
 \\
 =-\sqrt{3}+\frac{4\pi}{3}\\
 \end{align*}
