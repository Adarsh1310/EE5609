...
\begin{figure}[!h]
\centering
\resizebox{\columnwidth}{!}{\input{Triangle}}
\caption{Isoceles Triangle with \vec{BE} and \vec{CF} as altitude}
\label{myfig}
\end{figure}
...
\begin{align}
A_{\triangle{CEB}}=\frac{1}{2}\norm{\vec{A-C}}\norm{\vec{B-E}}\sin\ 90^{\circ}\\
A_{\triangle{CEB}}=\frac{1}{2}\norm{\vec{A-C}}\norm{\vec{B-E}}\label{2.0.4}
\end{align}
...
\begin{align}
A_{\triangle{BFC}}=\frac{1}{2}\norm{\vec{A-B}}\norm{\vec{C-F}}\sin\ 90^{\circ}\\
A_{\triangle{BFC}}=\frac{1}{2}\norm{\vec{A-B}}\norm{\vec{C-F}}\label{2.0.8}
\end{align}
Comparing $\triangle{CEB}$ and $\triangle{BFC}$
\begin{align}
\angle{ECB}=\angle{FBC}\\
\angle{CEB}=\angle{BFC}\\
BC=BC
\end{align}
By, AAS property $\triangle{CEB}$ $\cong$ $\triangle{BFC}$ and hence they will have equal area.Now by using \eqref{2.0.4} and \eqref{2.0.8}
\begin{align}
\frac{1}{2}\norm{\vec{A-C}}\norm{\vec{B-E}}=\frac{1}{2}\norm{\vec{A-B}}\norm{\vec{C-F}}\\
\norm{\vec{B-E}}=\norm{\vec{C-F}}[\because \norm{\vec{m}_{AB}}=\norm{\vec{m}_{AC}}]
\end{align}
Hence, the altitudes drawn to equal sides of isosceles triangle are equal.
\end{document}