...
$ Here, $\vec{BE}$  $\perp$ $\vec{AC}$ because $\vec{BE}$ is the altitude to side $\vec{AC}$.So,
 ...
 \implies \vec{(A-E+E-B+B-C)}^T\vec{(B-E)}=0\\
 \implies \vec{(A-E)}^T\vec{(B-E)}+\norm{\vec{B-E}}+\vec{(B-C)}^T\vec{(B-E)}=0\\
 \implies \norm{\vec{B-E}}+\vec{(B-C)}^T\vec{(B-E)}=0 \label{2}
\end{align}$
 ...
 \vec{(A-B)}^T\vec{(C-F)}=0\\
 \implies \vec{(A-F+F-C+C-B)}^T\vec{(C-F)}=0\\
 \implies \vec{(A-F)}^T\vec{(C-F)}+\norm{\vec{C-F}}+\vec{(C-B)}^T\vec{(C-F)}=0\\
 \implies \norm{\vec{C-F}}+\vec{(C-B)}^T\vec{(C-F)}=0\label{1}
 \end{align}
 Comparing equation \eqref{1} and \eqref{2}
\begin{multline}
\norm{\vec{C-F}}+\vec{(C-B)}^T\vec{(C-F)}=\\\norm{\vec{B-E}}+\vec{(B-C)}^T\vec{(B-E)}
\end{multline}
\begin{multline}
\norm{\vec{C-F}}+\norm{\vec{C-B}}\norm{\vec{C-F}}\cos\theta=\\\norm{\vec{B-E}}+\norm{\vec{B-C}}\norm{\vec{(B-E)}}\cos\theta
\end{multline}
\begin{multline}
\norm{\vec{C-F}}(1+\norm{\vec{C-B}}\cos\theta)=\\\norm{\vec{B-E}}(1+\norm{\vec{B-C}}\cos\theta)
\end{multline}
\begin{align}
\norm{\vec{C-F}}=\norm{\vec{B-E}}
\end{align}
