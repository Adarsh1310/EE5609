...
Suppose $\vec{A}$ is a 2$\times$1  matrix and $\vec{B}$ is 1$\times$2 matrix.Prove that $\vec{C}$=$\vec{A}$$\vec{B}$ is non invertible.
 ...
 \end{align}
 Reducing equation \eqref{eqn1}
 \begin{align}
 \myvec{ac&ad\\bc&bd}\\
 &\xleftrightarrow{R_2=R_2-\frac{b}{a}R_1}\myvec{ac&ad\\0&0}
 \end{align}
 Since one of the row of $\vec{C}$ is zero i.e. the rows are linearly dependent, we can say that the matrix is non invertible
