...
Suppose $\vec{A}$ is a 2$\times$1  matrix and $\vec{B}$ is 1$\times$2 matrix.Prove that $\vec{C}$=$\vec{A}$$\vec{B}$ is non invertible.
 ...
 x_1\vec{U}=-x_2\vec{V}
 \end{align}
 This shows that the two columns are a scalar multiple of each other and hence they will have a non trivial solution.So,we can say that $\vec{C}$ is non invertible.
