...
&\implies(1-\lambda)(\lambda^2 +\lambda+2) =0\label{eqEigen}
\end{align}
Where $\vec{I}$ is $3 \times 3$ Identity matrix. Now using Cayley Hamilton Theorem we get from \eqref{eqEigen} the following,
\begin{align}
(\vec{I}-\vec{A})(\vec{A}^2 +\vec{A}+2) =0\\
\vec{A}^2 +\vec{A}+2\vec{I}-\vec{A}^3-\vec{A}^2-2\vec{A} =0\\
