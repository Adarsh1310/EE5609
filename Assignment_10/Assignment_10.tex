...
\begin{itemize}
\item If we perform a + 0 then for any value of a from $\mathbb{F}$ the result will be a itself. Hence 0 is an identity element of + operation.If we perform a $\cdot$ 1 then for any value of a from $\mathbb{F}$ the result will be a itself. Hence 1 is an identity element of + operation. 
\end{itemize}
