...
Let $\vec{O}$ be the plane whose projection has to be obtained and \vec{P} be the final projection on the given plane.We have been provided with two orthonormal vector, let us call them $\vec{a}_1$,$\vec{a}_2$ and a direction vector of the light $\vec{d}$.Using these vectors we can find the plane as,
\begin{align}
