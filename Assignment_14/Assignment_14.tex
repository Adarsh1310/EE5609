...
\graphicspath{ {/user/adarshsrivastava/desktop/Matrix Theory/Assignemnt_7} }
 ...
 \end{align}
 Hence both scalar multiplication and vector addition hold true.Now we have to prove that the functions $\in$ $\mathbb{V}$ hold the property for additivity and homogeneity.
 So, we have to prove that (cf+g)(t) is equal to c(f)+g(t).
 \begin{align}
 (cf+g)(t)\\
 =(cf)(t)+g(t)\\
 =cf(t)+g(t)
