...
Let,
\begin{align}
\vec{V}_j=[T\alpha_j]_{\beta}\\
\vec{V}=\myvec{\vec{V}_1&\vec{V}_2&\vec{V}_3}
\end{align}
Using the given transformation,
\begin{align}
T\myvec{1\\0\\0}=\myvec{1\\-1}\\
T\myvec{0\\1\\0}=\myvec{1\\0}\\
T\myvec{0\\0\\1}=\myvec{0\\2}
\end{align}
So,T($\vec{\beta}$) can be written as,
\begin{align}
\vec{V}=\myvec{1&1&0\\-1&0&2}
\end{align}
Now, since the transformation has to be found relative to the pair $\vec{\beta}$, $\vec{\beta^{'}}$ we can rewrite the equation in the question as,
\begin{align}
